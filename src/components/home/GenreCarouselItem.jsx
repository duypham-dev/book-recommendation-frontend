  ...
  >
    {books !== undefined ? (
      books.length > 0 ? (
        ...
        <div className="py-8 text-center h-[260px] sm:h-[350px] flex items-center justify-center">
...
const CarouselSkeleton = ({ hasSubtitle = true }) => (
  <div className="mb-6 sm:mb-12 animate-pulse w-full">
    {/* Header Skeleton */}
    <div className="flex justify-between items-end mb-6">
      <div>
        <div className="h-6 sm:h-8 w-36 sm:w-48 bg-gray-200 dark:bg-gray-800 rounded"></div>
        {hasSubtitle && <div className="h-3.5 sm:h-4 w-24 sm:w-32 bg-gray-200 dark:bg-gray-800 rounded mt-2"></div>}
      </div>
      <div className="h-4 w-24 bg-gray-200 dark:bg-gray-800 rounded hidden sm:block"></div>
    </div>
    {/* Cards Skeleton */}
    <div className="flex gap-3 sm:gap-6 overflow-hidden p-2">
      {[...Array(6)].map((_, i) => (
        <div key={i} className="min-w-[130px] w-[130px] sm:min-w-[180px] sm:w-[180px] flex-shrink-0 space-y-3">
